...
namespace Order.UnitTests.Features.Orders.Commands.ConfirmOrder;
...
public class ConfirmOrderCommandHandlerTests
{
    ...
    public ConfirmOrderCommandHandlerTests()
    {
        ...
        _handler = new ConfirmOrderCommandHandler(_mockDbContext.Object, _correlation);
    }

    [Fact]
    public async Task Handle_WithExistingOrder_ShouldConfirmAndReturnResponse()
    {
        // Arrange
    ...
    public async Task Handle_WithNonExistingOrder_ShouldThrowNotFoundException()
    {
        ...
        var command = new ConfirmOrderCommand(nonExistingId);
